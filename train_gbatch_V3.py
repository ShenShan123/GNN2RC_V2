...
from models import NetCapClassifier, NetCapRegressor
import random
...
def evaluation_c(dataloader: dgl.dataloading.DataLoader, model: NetCapRegressor, 
...
def evaluation_r(dataloader: dgl.dataloading.DataLoader, model: NetCapRegressor, 
